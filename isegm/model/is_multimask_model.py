...
class MultiMaskModel(ISModel):
    ...
    def __init__(
        ...
        self.backbone = VisionTransformer(multi_mask_flag=True, **backbone_params)

        self.down_4_chan = backbone_params['embed_dim']
    ...
    def backbone_forward(self, image, coord_features=None):
        ...
        backbone_features = self.down_4(backbone_features)
