...
from .modeling.mask2former_helper.mask2former_despair_head import ClickDespair2FormerHead
...
def select_last_layer(cls_scores_list, mask_preds_list, rank_scores_list, onehot_scores_list,
                      alpha, batch_first: bool = False):
...
class MultiMaskDespairModel(ISModel):
    @serialize
    def __init__(
            self,
        ...
        self.head = ClickDespair2FormerHead(**head_params)
