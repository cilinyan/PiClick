...
from isegm.engine.trainer_multi import ISTrainerMulti

MODEL_NAME = 'multimask_2_base448_cocolvis_itermask'
...
def train(model, cfg, model_cfg):
    ...
    trainer = ISTrainerMulti(model, cfg, model_cfg, loss_cfg,
                             trainset, valset,
                             optimizer='adam',
