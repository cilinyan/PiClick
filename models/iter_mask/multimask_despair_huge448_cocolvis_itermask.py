...
from isegm.model.is_multimask_despair_model import MultiMaskDespairModel
from isegm.engine.trainer_rank import ISTrainerRank

MODEL_NAME = 'multimask_despair_large448_cocolvis_itermask'
...
def train(model, cfg, model_cfg):
    ...
    optimizer_params = {'lr': 5e-5 * 32 / cfg.batch_size, 'betas': (0.9, 0.999), 'eps': 1e-8}
