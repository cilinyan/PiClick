...
from isegm.model.is_multimask_with_ranking_simple_model import MultiMaskWithRankingModel
from isegm.engine.trainer_rank import ISTrainerRank

MODEL_NAME = 'multimask_ranking_2mlp_base448_cocolvis_itermask'
...
def train(model, cfg, model_cfg):
    ...
    loss_cfg = edict()
    loss_cfg.instance_loss = DETRLikeWithRankingLoss(num_queries=_PARAMS['num_queries'],
                                                     num_classes=_PARAMS['num_classes'])
