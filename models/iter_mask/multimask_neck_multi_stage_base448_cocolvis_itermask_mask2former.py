...
from isegm.model.modeling.mask2former_helper.mask2former_losses import Mask2FormerDETRLikeLoss
from isegm.model.is_multimask_neck_multi_stage_model_mask2former import MultiMaskNeckMultiStageModelMask2Former

MODEL_NAME = 'multimask_neck_multi_stage_base448_cocolvis_itermask_mask2former'
...
def init_model(cfg):
    ...
    model = MultiMaskNeckMultiStageModelMask2Former(
        num_classes=_PARAMS['num_classes'],
        num_queries=_PARAMS['num_queries'],
        use_disks=True,
        norm_radius=5,
...
def train(model, cfg, model_cfg):
    ...
    loss_cfg = edict()
    loss_cfg.instance_loss = Mask2FormerDETRLikeLoss(num_queries=_PARAMS['num_queries'],
                                                     num_classes=_PARAMS['num_classes'])
