...
MODEL_NAME = 'multimask_despair_long_base448_cocolvis_itermask'
...
def train(model, cfg, model_cfg):
    ...
    lr_scheduler = partial(torch.optim.lr_scheduler.MultiStepLR, milestones=[60, 70], gamma=0.1)
