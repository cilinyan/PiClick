...
MODEL_NAME = 'maskformer_r_plainvit_base448_finetune'
...
def init_model(cfg):
    ...
    model.backbone.init_weights_from_pretrained('./weights/models/iter_mask/maskformer_r_plainvit_base224/029/checkpoints/054.pth')
    model.to(cfg.device)
