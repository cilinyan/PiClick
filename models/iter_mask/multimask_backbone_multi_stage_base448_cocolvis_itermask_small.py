...
from isegm.model.is_multimask_backbone_multi_stage_model import MultiMaskBackboneMultiStageModel

MODEL_NAME = 'multimask_backbone_multi_stage_base448_cocolvis_itermask_small'
...
def init_model(cfg):
    ...
    head_params = dict(
        ...
        out_channels=256,
        transformer_decoder_num_layers=4,
    )

    model = MultiMaskBackboneMultiStageModel(
        num_classes=_PARAMS['num_classes'],
        num_queries=_PARAMS['num_queries'],
        use_disks=True,
        norm_radius=5,
        ...
        backbone_output_blocks=(6, 8, 10, 12),
        multi_scale_feature_dim=256,
    )
