...
from isegm.model.is_multimask_neck_multi_stage_model import MultiMaskNeckMultiStageModel

MODEL_NAME = 'multimask_neck_multi_stage_base448_cocolvis_itermask'
...
def init_model(cfg):
    ...
    model = MultiMaskNeckMultiStageModel(
        num_classes=_PARAMS['num_classes'],
        num_queries=_PARAMS['num_queries'],
        use_disks=True,
        norm_radius=5,
