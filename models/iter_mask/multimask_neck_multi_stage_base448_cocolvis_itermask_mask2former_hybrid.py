...
from isegm.model.is_multimask_neck_multi_stage_model_mask2former_hybrid import MultiMaskNeckMultiStageModelMask2FormerHybrid

MODEL_NAME = 'multimask_neck_multi_stage_base448_cocolvis_itermask_mask2former_hybrid'
